...
import Main exposing (compress, decompress)
        ...
        [ describe "Compressions"
            [ describe "Compress"
                [ test "Hallo Welt" <|
                    \() ->
                        compress "Hallo Welt"
                            |> Expect.equal ( Node (Node (Node (Leaf { char = 'W', numberOf = 1 }) (Leaf { char = 'a', numberOf = 1 })) (Node (Leaf { char = ' ', numberOf = 1 }) (Leaf { char = 'H', numberOf = 1 }))) (Node (Node (Leaf { char = 't', numberOf = 1 }) (Node (Leaf { char = 'e', numberOf = 1 }) (Leaf { char = 'o', numberOf = 1 }))) (Leaf { char = 'l', numberOf = 3 })), [ [ Left, Right, Right ], [ Left, Left, Right ], [ Right, Right ], [ Right, Right ], [ Right, Left, Right, Right ], [ Left, Right, Left ], [ Left, Left, Left ], [ Right, Left, Right, Left ], [ Right, Right ], [ Right, Left, Left ] ] )
                , test "Short" <|
                    \() ->
                        compress "short"
                            |> Expect.equal ( Node (Node (Leaf { char = 'h', numberOf = 1 }) (Leaf { char = 'o', numberOf = 1 })) (Node (Leaf { char = 't', numberOf = 1 }) (Node (Leaf { char = 'r', numberOf = 1 }) (Leaf { char = 's', numberOf = 1 }))), [ [ Right, Right, Right ], [ Left, Left ], [ Left, Right ], [ Right, Right, Left ], [ Right, Left ] ] )
                ]
            , describe "Decompress"
                [ test "Short" <|
                    \() ->
                        decompress
                            (Node (Node (Leaf { char = 'h', numberOf = 1 }) (Leaf { char = 'o', numberOf = 1 })) (Node (Leaf { char = 't', numberOf = 1 }) (Node (Leaf { char = 'r', numberOf = 1 }) (Leaf { char = 's', numberOf = 1 }))))
                            [ [ Right, Right, Right ], [ Left, Left ], [ Left, Right ], [ Right, Right, Left ], [ Right, Left ] ]
                            |> Expect.equal "short"
                , test "Hallo Welt" <|
                    \() ->
                        decompress
                            (Node (Node (Node (Leaf { char = 'W', numberOf = 1 }) (Leaf { char = 'a', numberOf = 1 })) (Node (Leaf { char = ' ', numberOf = 1 }) (Leaf { char = 'H', numberOf = 1 }))) (Node (Node (Leaf { char = 't', numberOf = 1 }) (Node (Leaf { char = 'e', numberOf = 1 }) (Leaf { char = 'o', numberOf = 1 }))) (Leaf { char = 'l', numberOf = 3 })))
                            [ [ Left, Right, Right ], [ Left, Left, Right ], [ Right, Right ], [ Right, Right ], [ Right, Left, Right, Right ], [ Left, Right, Left ], [ Left, Left, Left ], [ Right, Left, Right, Left ], [ Right, Right ], [ Right, Left, Left ] ]
                            |> Expect.equal "Hallo Welt"
                ]
            ]
